...
import { Heart, HelpCircle, Calculator, FileText, Truck, ClipboardCheck } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-8">
          ...
          <div className="flex flex-wrap items-center gap-4 justify-center md:justify-end">
            ...
            <a
              href="https://www.tiktok.com/@velunaxph"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.facebook.com/velunaxph"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-500 hover:text-[#1877F2] transition-colors flex items-center gap-2 text-sm font-medium"
            >
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
